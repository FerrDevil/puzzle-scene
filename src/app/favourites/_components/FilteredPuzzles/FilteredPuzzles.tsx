...
export default function FilteredPuzzles() {
    ...
    const filteredPuzzles = puzzles
        .filter(puzzle => puzzle.isFavourited)
        ...
        .sort((a, b) => filters.favouritedDateSort === "ascend" ? 
            Number(a.favouritedDatetime) -  Number(b.favouritedDatetime) 
        : 
            Number(b.favouritedDatetime) - Number(a.favouritedDatetime)
        )
